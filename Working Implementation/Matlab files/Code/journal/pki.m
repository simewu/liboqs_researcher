...
x = categorical({'RSA 2048','RSA 4096','P256','Dilithium 2','Dilithium 3','Dilithium 5','Falcon 512','Falcon 1024','SPHINCS+Haraka128frobust','SPHINCS+SHA256128frobust','SPHINCS+SHAKE256128frobust'});
x = reordercats(x,{'RSA 2048','RSA 4096','P256','Dilithium 2','Dilithium 3','Dilithium 5','Falcon 512','Falcon 1024','SPHINCS+Haraka128frobust','SPHINCS+SHA256128frobust','SPHINCS+SHAKE256128frobust'});

if selection == 1
    % 1 for cert gen
    y = [4.74 11.15 4.66 3.84 3.99 4.05 3.97 4.37 11.48 41.58 89.76];
    bar(x,y)
...
elseif selection == 2
    %2 for cert ver
    y = [2.44 2.63 4.5 3.05 3.59 3.73 3.35 3.53 4.7 10.17 24.28];
    bar(x,y)
