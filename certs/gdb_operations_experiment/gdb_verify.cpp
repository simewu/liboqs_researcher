...
unsigned int message_length = 13;
unsigned char message_bytes[13];
size_t temp_siglen;

void log() {
	bool valid = OQS_SIG_verify(sig, message_bytes, message_length, signature, sig->length_signature, public_key) == OQS_SUCCESS;
}
